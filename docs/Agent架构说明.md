...
- 量化数据：PLAN-v2 估算原文精选约 0.56M tokens，全文改写约 2.8M tokens，成本约下降 5 倍。当前 4 本教材实测保留 132,983 字，原始 1,876,919 字，压缩比 7.1%。
...
| 实验 | 数据 |
| --- | --- |
| Phase 3 跨教材整合 | 4 本教材，545 原始节点，199 整合节点，16 merge，压缩比 7.1% |
| Phase 4 RAG 测试集 | 10 题，3494 chunks，keyword_hit@5=100%，book_hit@5=100%，耗时 34.8s |
...
| P1 | 当前实测报告先沉淀 4 本教材快照，最终应覆盖 7 本教材 | Phase 7 全量重跑 7 本教材图谱、整合和 RAG 索引 |
